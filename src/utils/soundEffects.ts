// Web Audio API Synthesizer & Speech Synthesis for Educational Feedback
...
class SoundManager {
  ...
  // Play pleasant chime when gesture is recognized or challenge is correct
  ...
  // Play victory celebration tune for completing AI challenge
  ...
  // Gentle buzzer for incorrect math attempt
  ...
  // Play attention-getting alarm chime for emergency SOS cards
  ...
  // Speech Synthesis: speak Vietnamese text for middle school students
